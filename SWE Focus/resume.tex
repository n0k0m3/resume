...
\address{\href{https://www.linkedin.com/in/minhnguyen251/}{LinkedIn Profile}} % LinkedIn URL
...
%         \item Love clearing up jargons (especially in Machine Learning) with easy-to-understand concepts.
%     \end{rSubsection}
% \end{rSection}
